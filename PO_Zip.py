...
def fetch_po(company_id, cname):
    ...
    def map_record(rec):
        ...
        return {
            ...
            "Gate Entry":       "TRUE" if gate is True else ("" if not gate else gate),
            "Last Approver":    (rec.get("last_approver") or {}).get("display_name", ""),
            "Next Approver":    (rec.get("next_approver") or {}).get("display_name", ""),
